...
import miniFormBody from '../../__mocks__/forms/json-forms/mini-form.json';
...
import nestedForm1Body from '../../__mocks__/forms/json-forms/nested-form1.json';
import nestedForm2Body from '../../__mocks__/forms/json-forms/nested-form2.json';
import formComponentSkeleton from '../../__mocks__/forms/omrs-forms/form-component.json';
import formComponentBody from '../../__mocks__/forms/json-forms/form-component.json';
import artComponentSkeleton from '../../__mocks__/forms/omrs-forms/component_art.json';
import artComponentBody from '../../__mocks__/forms/json-forms/component_art.json';
import preclinicReviewComponentSkeleton from '../../__mocks__/forms/omrs-forms/component_preclinic-review.json';
import preclinicReviewComponentBody from '../../__mocks__/forms/json-forms/component_preclinic-review.json';
